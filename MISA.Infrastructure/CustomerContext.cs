...
namespace MISA.Infrastructure
{
    public class CustomerContext
    {
        ...
        /// CreatedBy: PQKHANH (2/1/2021)
        public IEnumerable<Customer> GetCustomers()
        {
            // Kết nối tới CSDL
            var connectionString = "User Id=dev;Host=35.194.135.168;Port=3306;Database=MISACukCuk_Development_PQKhanh; Password=12345678@Abc; Character Set=utf8";
